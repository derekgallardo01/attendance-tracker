...
describe('getActivityPulse', () => {
  ...
  test('computes distinct-active windows, signups, exports, upgrades, check-ins', async () => {
    ...
    seedEvent('a.com', 'old@a.com', 'export_success', now - 3 * 3600e3); // NOT counted — panel dup of 'exported'
    ...
    expect(p.exports24h).toBe(1);     // 'exported' only (export_success is the panel's dup)
